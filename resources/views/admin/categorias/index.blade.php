            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-primary btn-sm" href="{{ url('/admin/categorias/create') }}">Crear nuevo</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <form action="{{ url('/admin/categorias/' . $categoria->id) }}" id="miformulario{{$categoria->id}}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
