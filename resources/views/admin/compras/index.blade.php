            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-primary btn-sm" href="{{ url('/admin/compras/create') }}">Crear nuevo</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="{{ url('/admin/compra/' . $compra->id) }}" class="btn btn-info"><i
                                                    class="fas fa-eye"></i>Ver</a>
                                            <a href="{{ url('/admin/compra/' . $compra->id . '/edit') }}"
                                                class="btn btn-success"><i class="fas fa-pencil-alt"></i>Editar</a>
                                            <form action="{{ url('/admin/compra/' . $compra->id) }}" id="miformulario{{$compra->id}}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
