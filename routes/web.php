...
Route::post('/admin/categorias/create', [App\Http\Controllers\CategoriaController::class, 'store'])->name('categorias.create')->middleware('auth');
// ruta visaalizar categoria
...
Route::post('/admin/sucursales/create', [App\Http\Controllers\SucursalController::class, 'store'])->name('sucursales.create')->middleware('auth');
...
Route::post('/admin/productos/create', [App\Http\Controllers\ProductoController::class, 'store'])->name('productos.create')->middleware('auth');
...
Route::post('/admin/proveedores/create', [App\Http\Controllers\ProveedorController::class, 'store'])->name('proveedores.create')->middleware('auth');
...
Route::post('/admin/compras/create', [App\Http\Controllers\CompraController::class, 'store'])->name('compras.create')->middleware('auth');
